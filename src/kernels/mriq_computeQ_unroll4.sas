...
.text
	...
	bufquery.dim_x s5, 6
	ldglin v4, 5
	smovssp sc.sd_words, 16		// The sldsp will load 16 words from the
								// scratchpad. Other loads are unaffected.
	
loop_compute:
	sand s3, s4, 1023
	#bound branchcycle 63 1 63
...
skip_kindex_load:
	...
	mul v11, v0, s15
	mul v14, v0, s19
	siadd s4, s4, 16			// 4* loop counter, offset into kvalues to read
								// to SP.
	mad v5, v1, s8, v5
	mad v8, v1, s12, v8
	mad v11, v1, s16, v11
	...
	mad v11, v2, s17, v11
	mad v14, v2, s21, v14
	siadd s6, s6, 16				// offset in scratchpad
	mul v5, v5, M_2PI_F
	mul v8, v8, M_2PI_F
	mul v11, v11, M_2PI_F
	mul v14, v14, M_2PI_F
